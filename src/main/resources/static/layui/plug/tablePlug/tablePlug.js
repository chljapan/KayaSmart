                ...
                success: function (layero, index) {
                  ...
                  table.render({
                    ...
                    cols: [[
                      ...
                      {
                        field: 'name',
                        title: 'Select All<span class="table-filter-opt-invert" onclick="layui.tablePlug && layui.tablePlug.tableFilterInvert(this);">Select Invert</span>'
                      }
                    ]]
                  })
                },
    ...
    switch (obj.event) {
      case 'LAYTABLE_COLS':
        ...
        $('<li class="layui-form" lay-filter="LAY_TABLE_TOOL_COLS_FORM">' +
          ...
          + ((checkboxElem.length === checkboxCheckedElem.length) ? 'checked' : '') + ' title="All">' +
          '<span class="LAY_TABLE_TOOL_COLS_Invert_Selection">Invert</span></li>')
